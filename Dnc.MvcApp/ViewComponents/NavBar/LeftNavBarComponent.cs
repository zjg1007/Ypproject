...
namespace Dnc.MvcApp.ViewComponents.NavBar
{
    ...
    public class LeftNavBarComponent:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            await Task.Run(()=> {
                navBarItems.Add(new LeftNavBarItemViewModel("影院管理", "/Cinema/index"));
                navBarItems.Add(new LeftNavBarItemViewModel("演员管理", "/Actor/Index"));
                navBarItems.Add(new LeftNavBarItemViewModel("前台上映", "/Proscenium/Index"));
            });
