...
function listInfo() {
    ...
    list.innerHTML += '<option value="北京">北京</option>\
...
　　　　　　　　　　　　　　　　　　　　　　　　　　　 <option value="台湾">台湾</option>';
    ...
    function result() {
        ...
        resultShow.innerHTML = "你选择的是" + province[Province.value] + "省" + City.value + "市!";
    }
...
//图片上传
    ...
    function previewImage(file) {
        ...
        if (file.files && file.files[0]) {
            div.innerHTML = '<img id=imghead style="border-radius:6px;">';
